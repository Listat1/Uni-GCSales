...
try {
    ...
    $stmt = $pdo->prepare("SELECT o.order_id, o.total_amount, o.created_at, p.name 
        AS item_name
        FROM orders o 
...
<?php
// Display Notification Banner if set 
        ...
        <div id="postItemsBody" class="collapse" data-bs-parent="#dashboardAccordion">
            <div class="card-body">
                ...
                <div class="list-group list-group-flush" id="userProductHistory">
                    ...
                    if (empty($myProducts)): 
                    ?>
                        <div class="list-group-item bg-transparent text-muted small">
                            No items listed.
                        </div>
                    <?php
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center bg-transparent text-reset border-secondary product-item" 
                                ...
                                <div>
                                    ...
                                    <?php if ($item['status_id'] == 3 && $item['buyer_name']): ?>
                                        <br><small class="text-success">Purchased by: <?= htmlspecialchars($item['buyer_name']) ?></small>
                                    <?php endif; ?>
                                </div>
