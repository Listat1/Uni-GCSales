...
<div class="collapse navbar-collapse" id="navbarContent">
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" id="navList">
        <li class="nav-item">
            <a class="nav-link <?= ($pageID == 'home') ? 'active fw-bold' : '' ?>" href="index.php">Home</a>
        </li>

        <?php if (isset($_SESSION['user_id'])): ?>
            <li class="nav-item">
                <a class="nav-link <?= ($pageID == 'dashboard') ? 'active fw-bold' : '' ?>" href="dashboard.php">Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($pageID == 'basket') ? 'active fw-bold' : '' ?>" href="basket.php">Basket</a>
            </li>
            <li class="nav-item">
